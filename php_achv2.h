...
#define PHP_ACHV2_VERSION "0.1.0" /* Replace with version number for your extension */
...
ZEND_BEGIN_MODULE_GLOBALS(achv2)
	long  global_value;
	char *global_string;
ZEND_END_MODULE_GLOBALS(achv2)
*/

/* In every utility function you add that needs to use variables 
   in php_achv2_globals, call TSRMLS_FETCH(); after declaring other 
   variables used by that function, or better yet, pass in TSRMLS_CC
   after the last function argument and declare your utility function
   with TSRMLS_DC after the last declared argument.  Always refer to
   the globals in your function as ACHV2_G(variable).  You are 
   encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/

#ifdef ZTS
#define ACHV2_G(v) TSRMG(achv2_globals_id, zend_achv2_globals *, v)
#else
#define ACHV2_G(v) (achv2_globals.v)
#endif
